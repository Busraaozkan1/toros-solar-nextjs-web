...
export default function HomePage() {
  ...
  useEffect(() => {
    fetch('/api/products')
      .then(res => {
        if (!res.ok) throw new Error('API yanit vermiyor');
        return res.json();
      })
      .then(data => {
      ...
      .catch(err => console.error('Urunler yuklenirken hata olustu:', err));
    ...
    fetch('/api/projects')
      ...
      .catch(err => console.error('Projeler yuklenirken hata olustu:', err));
  }, []);
