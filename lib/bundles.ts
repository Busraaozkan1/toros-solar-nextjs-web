...
export const BUNDLES: Bundle[] = [
  {
    ...
    components: [
      "6 kW off-grid inverter (dahili MPPT)",
  ...
  },
  {
    ...
    components: [
      "5 kW Deye hibrit inverter",
      "9 × 610 W TOPCon panel — 5,5 kWp",
      "5 kWh LiFePO₄ batarya (opsiyonel)",
      "Bataryasız (şebeke) seçeneği mevcut",
    ],
    icon: "bi-house",
  },
  {
    ...
    components: [
      "8 kW Deye hibrit inverter",
      "15 × 610 W TOPCon panel — 9,2 kWp",
      "10 kWh LiFePO₄ batarya",
      "12 kW'a yükseltme seçeneği",
    ],
    icon: "bi-houses",
  },
  {
    ...
    components: [
      ...
      "27 × 610 W TOPCon panel — 16,5 kWp",
      "15 kWh LiFePO₄ batarya",
      "Tarımsal sulama sistemlerine uygun",
    ],
    icon: "bi-buildings",
  },
];
